# -*- coding: utf-8 -*-
'''
@File    :   dt_based_bc_for_tactics_generation.py
@Time    :   2024/05/29 14:10:12
@Author  :   Mingjiang Liu 
@Version :   1.0
@Desc    :   decision transformer based behaviour cloning for tactics generation
'''
...
class DecisionTransformerBCTactics(TrajectoryModel):

    """
    This model uses DecisionTransformer based BC to model tactics generation problem 
